...
cfg.musicNumber = process.env.MUSIC_NUMBER;
cfg.elfNumber = process.env.ELF_NUMBER;
...
cfg.mongoUrl = process.env.MONGOLAB_URI || process.env.MONGO_SANTA_URL || process.env.MONGO_PORT_27017_TCP_ADDR;
